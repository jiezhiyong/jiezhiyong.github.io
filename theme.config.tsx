...
import { type DocsThemeConfig, Navbar, ThemeSwitch } from "nextra-theme-docs";
...
const logo = (
  <svg
    ...
    className="jsx-37c7cf7a4c4dcf24"
  >
    <path
...
const config: DocsThemeConfig = {
  ...
  head: () => (
    <>
      ...
      <meta content="https://nextra.site/favicon.png" name="twitter:image" />
      <meta content="https://nextra.site/favicon.png" name="og:image" />
