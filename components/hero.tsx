...
function fitElementToParent(el, padding?: number) {
...
export function Hero() {
  ...
  return (
    <div className="bg-slate-900 dark relative overflow-hidden rounded-lg">
      <div className="animation-wrapper absolute right-0 top-0 bottom-0">
        <div className="sphere-animation" ref={animationRef}>
          <svg
            className="sphere"
            viewBox="0 0 440 440"
      ...
      <div className="hero-index relative overflow-hidden py-48">
        ...
        <Wrapper>
          <div className="flex flex-col gap-16 xl:flex-row xl:items-center xl:justify-between">
            <div className="max-w-2xl">
              <h1 className="to-primary inline bg-gradient-to-r from-white via-sky-100 bg-clip-text text-3xl leading-tight tracking-tight text-transparent lg:text-5xl">
                <strong className="font-semibold">
                  Document accumulation and sharing
                </strong>
              </h1>
            </div>
          </div>
